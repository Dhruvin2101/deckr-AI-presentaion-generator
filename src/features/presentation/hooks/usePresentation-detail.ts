...
import type { SlideLayout, SlideStyle, SlideTone } from '../constant/presentation-options'
...
import { getPresentationWithSlide } from '../actions/presentation-query'
...
export function usePresentationDetail(
    ...
    const query = useQuery({
        ...
        queryFn: ()=>getPresentationWithSlide({data:{id:presentationId}}),
